...
<p>When you\'re done, you should have something like this:</p> <img src="images/samplematrix.png"> <p>In this example, Hypothesis 1 is looking pretty unlikely. (But remember, that doesn\'t necessarily mean that Hypothesis 2 is correct. Our goal  is to <a href="ach.php#refuting">refute hypotheses</a>, not prove them.)</p> 
