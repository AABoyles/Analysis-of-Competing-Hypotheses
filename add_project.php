...
echo '<!DOCTYPE html><html><head><title>ACH: Create New Project</title>';
...
<div class="mainContainer">
	...
	echo '			<h3>Project Privacy'. helpLink('howto_project_management.php#project_privacy'). '</h3>
					<br />
	...
	echo '<div class="mainContainer wide">
		<div class="ydsf left">
			<div class="inner">
				<div class="main">
					<h2>Access Denied</h2>
