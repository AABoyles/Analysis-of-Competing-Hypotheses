...
<p>If you no longer want to participate in a project, click the Leave Project link. This link will be revealed if you click the Show Details link next to the project header. When you leave, your consistency scores will no longer be reflected in the Group Matrix; however, in case you decide to return later, all of your scores will be preserved.</p>
<p>If you are the project owner, you cannot leave a project until you designate a new owner on the Edit Project Options page.</p>
