...
<select id="hypotheses_column_sort" onChange="setStyleByClass('th','hypothesis_colgroup_added','display','none'); setStyleByClass('th','hypothesis_colgroup_alpha','display','none'); setStyleByClass('th','hypothesis_colgroup_least_likely_compare','display','none'); setStyleByClass('th','hypothesis_colgroup_most_likely_compare','display','none'); setStyleByClass('th','hypothesis_colgroup_'+this.options[selectedIndex].value,'display',''); setStyleByClass('td','colgroup_added','display','none'); setStyleByClass('td','colgroup_alpha','display','none'); setStyleByClass('td','colgroup_least_likely_compare','display','none'); setStyleByClass('td','colgroup_most_likely_compare','display','none'); setStyleByClass('td','colgroup_'+this.options[selectedIndex].value,'display',''); sortColsBy = this.options[selectedIndex].value;">
	<option value="added">Date Added</option>
	<option value="most_likely_compare">Most Likely</option>
	<option value="least_likely_compare">Least Likely</option>
