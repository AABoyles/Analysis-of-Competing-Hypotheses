...
<input type="checkbox" id="flag" onclick="if(document.getElementById('flag').checked == true) { setStyleByClass('td','dclFlag','display','table-cell'); setStyleByClass('td','dcFlag','display','table-cell'); } else { setStyleByClass('td','dclFlag','display','none'); setStyleByClass('td','dcFlag','display','none'); }">Flag</span></p>
...
<?php
	...
	for( $j = 0; $j < count($active_project->hypotheses); $j++ ) {
		...
		echo("<td onmouseover=\"return overlib('");
		...
		echo($compare_user_2->name . ": " . $rating);
...
var st1 = new SortableTable(document.getElementById("compareMatrix"), ["String", "String", "String", "String", "String", "String", "String", "String", ]);
</script>