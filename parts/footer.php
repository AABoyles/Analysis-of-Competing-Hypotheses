...
if( $print_mode ) {
	if ($active_project->classification == 'U') {
...
echo "<div class='$classificationBannerStyle'>
<p>Overall Project Classification: <b>" . Project::classificationText($active_project->classification) . "</b></p></div>";

} 

echo '<p>Based on <a href="http://competinghypotheses.org">The Open Source ACH Project</a> | <a href="about.php">About this instance</a></p>';
